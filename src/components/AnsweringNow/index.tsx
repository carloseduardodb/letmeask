...
type AnsweringNowProps = {
  questionHighlighted: QuestionProps[];
...
const AnsweringNow = ({
  ...
  return (
    <section>
      <h1 className="font-display text-md text-p-black font-semibold mb-5 dark:text-p-white">
        Respondendo agora
      </h1>
            ...
            >
              <div className="flex flex-row items-center">
                ...
                {!question.isAnswered && (
                  <>
                    ...
                    >
                      <FiCheckCircle
                        size={18}
                        className={`p-0 transition delay-50 duration-300 ease-in-out`}
                      />
                    </button>
                    ...
                    <button
                      ...
                      className={`text-blue-700 flex items-center justify-center 
                         hover:text-p-white hover:bg-blue-700 w-12 h-8 px-2 
                         py-1 rounded-full ${
                ...
                <button
                  ...
                  className="text-p-danger flex items-center justify-center 
                  hover:text-p-white hover:bg-p-danger w-12 h-8 px-2 py-1 
                  rounded-full"
                  aria-label="Apagar pergunta"
                >
                  <FiTrash
